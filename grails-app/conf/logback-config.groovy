...
String LOG_NAME = System.getenv('LOG_NAME') ?: System.getProperty('log.name') ?: 'pndimo'
String TARGET_LOG_DIRECTORY = System.getenv('TARGET_LOG_DIRECTORY') ?: System.getProperty('target.log.directory') ?:"."
Level logLevel =  Level.toLevel(System.getenv('LOG_LEVEL') ?: System.getProperty('log.level'), ERROR)
...
appender("ROLLING_FILE", RollingFileAppender) {
    ...
    rollingPolicy(FixedWindowRollingPolicy) {
        fileNamePattern = "${TARGET_LOG_DIRECTORY}/${LOG_NAME}.%i.log"
        minIndex = 1
        maxIndex = 10
    }
...
logger("grails.app", ERROR, ['STDOUT','ROLLING_FILE'], false)
